INSERT INTO user(user_id,activated,activation_key,email,first_name,image_url,lang_key,last_name,login,password_hash,reset_date,reset_key) values (1,1,null,'go.silva@cgi.com','Goncalo','the_url','pt','Silva','silvagc','$2a$10$2UTqjIha3WumooGvQaFQm.7U7bINyjBXuAu42H5wqFP2MpfVBzxp.',null,null);
